import { getWireGcodeFromOp } from '../cam-gcode-wire'
...
onmessage = (event) => {
    ...
    getWireGcodeFromOp.apply(this, [settings, opIndex, op, geometry, openGeometry, tabGeometry, showAlert, done, progress])
