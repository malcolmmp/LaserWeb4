import { getPenPlotGcodeFromOp } from '../cam-gcode-penplot'
...
onmessage = (event) => {
    ...
    try{
        getPenPlotGcodeFromOp.apply(this, [settings, opIndex, op, geometry, openGeometry, tabGeometry, showAlert, done, progress])
    }catch(e){
      console.error(e);
